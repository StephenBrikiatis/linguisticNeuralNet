...
for iterLimit in range(0,iterations):
    ...
    if lang == 'eng':
        ...
        sourceIterations.insert(0, nextSources)
        lang = 'eng'
    while nextSources:
...
print(wordData.loc['honey'])

#Create an initial nxn (n = total words found) matrix
#This will be reduced to a standard size via principal component analysis


#reduce the dimensionality of the dataset to m x m
